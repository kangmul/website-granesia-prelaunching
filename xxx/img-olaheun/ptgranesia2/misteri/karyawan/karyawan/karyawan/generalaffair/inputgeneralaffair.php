...
<form class="form-container" id="form1" name="form1" method="post" action="prosesgeneralaffair.php">
<div class="form-title"><h2>TAMBAH DATA</h2></div>
<div class="form-title">FOTO</div>
<input class="form-field" type="file" name="foto" REQUIRED/><br />
<div class="form-title">NAMA</div>
<input class="form-field" type="text" name="nama" REQUIRED/><br />
<div class="form-title">ALAMAT</div>
<input class="form-field" type="text" name="alamat" REQUIRED/><br />
<div class="form-title">AWAL</div>
<input class="form-field" type="date" name="awal" REQUIRED/><br />
<div class="form-title">STATUS</div>
<input class="form-field" type="text" name="status" REQUIRED/><br />
