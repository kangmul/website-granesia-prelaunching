...
$sql="insert into komisaris (foto,nama,alamat,awal,status) values ('$foto','$nama','$alamat','$awal','$status')";
$hasil=mysql_query($sql);
// Validasi 
if($hasil){
echo "<script>alert('SUKSES MENAMBAHKAN DATA');
document.location.href='../../../fitur/karyawan/komisaris/list.php'</script>\n";
} else {
