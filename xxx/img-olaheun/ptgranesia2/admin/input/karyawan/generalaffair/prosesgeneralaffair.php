...
$sql="insert into generalaffair (foto,nama,alamat,awal,status) values ('$foto','$nama','$alamat','$awal','$status')";
$hasil=mysql_query($sql);
// Validasi 
if($hasil){
echo "<script>alert('SUKSES MENAMBAHKAN DATA');
document.location.href='../../../fitur/karyawan/generalaffair/list.php'</script>\n";
} else {
