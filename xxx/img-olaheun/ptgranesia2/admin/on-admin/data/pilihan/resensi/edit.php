...
$query = mysql_query ("select * from resensi where id='$id'");
...
<input class="form-field" type="text" name="Judul" REQUIRED/><br><?php echo $data['Judul']?><br><br>
<div class="form-title">KETERANGAN</div>
<input class="form-field" type="text" name="ket" REQUIRED/><br><?php echo $data['ket']?><br>
