...
$query = mysql_query ("select * from email where id='$id'");
...
<input class="form-field" type="text" name="email" REQUIRED/><br><?php echo $data['email']?><br><br>
<div class="form-title">PESAN</div>
<input class="form-field" type="text" name="pesan" REQUIRED/><br><?php echo $data['pesan']?><br>
