...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Kontak</label></h3>
				<!-- <legend>
					CRUD PHP & Bootstrap
				</legend> -->
					...
					<tr class="info">
						...
						<td>
							...
							<a href="index.php?t=data&p=slide_show&f=slideshow_form_update&id=<?php  echo $rows['id']; ?>" class="btn-sm btn btn-warning">
								<i class="glyphicon glyphicon-pencil"></i> Balas Pesan</a>
							<a href="index.php?p=kontak&f=kontak_act_delete&id=<?php  echo $rows['id']; ?>"
