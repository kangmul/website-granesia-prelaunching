...
$query="SELECT * FROM user LEFT JOIN user_group ON user_group.gid = user.gid where user.uid= ".$uid." AND user_group.gid != '1' AND user.su = '0'";
...
<div class="panel panel-info">
    ...
    <form action="index.php?t=menuuser&p=users&f=user_act_update_data" method="post" id="form_update" name="form_update">
    ...
    <table width="800" border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<div class="row">
								<div class="col-xs-4">
									<input type="text" class="form-control" name="country" id="country" style=" width:200px;" value="<?php echo $data['country'];?>" />
								</div>
							</div>
