...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Update Promo</label></h3>

				<a class="btn btn-success" href="index.php?t=data&p=promo&f=promo_form_view"> <i class="glyphicon glyphicon-arrow-left"></i> Kembali</a>

				<h3>Update Gambar</h3>

				<div class="panel panel-info">
		 <div class="panel-body">
				<form action="index.php?t=data&p=promo&f=promo_act_update" method="post" id="form_update" name="form_update" enctype="multipart/form-data">
					...
					<div class="control-group">
							...
							<?php
									if(empty($data['gambar'])){
											echo "<img src=app/promo/files/noimage.jpg width=55 height=55 class=img-rounded>";
										}
										else{
											echo "<img src=app/promo/files/$data[gambar] width=150 height=150 class=img-rounded>";
										}
								?> 
						  ...
						  <tr></br>
                            <td><label>Nama Promo : </label></td></br>
                            <td>
