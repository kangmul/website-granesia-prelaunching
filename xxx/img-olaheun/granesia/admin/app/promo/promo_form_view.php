...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Promo</label></h3>
				...
				<a href="index.php?p=promo&f=promo_form_insert" class="btn-bg btn  btn-success pull-right">
				...
				<table class="table table-condensed table-bordered" id="example">
					...
					<tr class="info">
						...
						<td> <?php if(empty($rows['gambar'])){
											...
											echo "<img src=app/promo/files/$rows[gambar] width=75 height=75 class=img-rounded>";
										}
										?></td>
						...
						<td> <div class="btn-group">
							...
							<a href="index.php?t=data&p=promo&f=promo_form_update&id=<?php  echo $rows['id']; ?>" class="btn-small btn btn-warning">
								<i class="glyphicon glyphicon-pencil"></i> Update</a>
							<a href="index.php?t=data&p=promo&f=promo_act_delete&id=<?php  echo $rows['id']; ?>"
