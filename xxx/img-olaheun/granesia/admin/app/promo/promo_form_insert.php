...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Input Promo</label></h3>


		
				<a class="btn btn-success" href="index.php?p=promo&f=promo_form_view"> <i class="glyphicon glyphicon-arrow-left"></i> Kembali</a>

				
				<h3>Input Gambar</h3>
					<div class="panel panel-info">
		 <div class="panel-body">
				<form action="index.php?t=data&p=promo&f=promo_act_insert" method="post" id="form_insert" name="form_insert" enctype="multipart/form-data" >
						 ...
						 <tr>
						  ...
						  <tr>
                            ...
                            <td>
								...
								id="keterangan" placeholder="Nama Promo" maxlength="100" required/>							
							</td>
                          </tr>
						  </br>
						  <tr>
