...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Update Resensi</label></h3>

				<a class="btn btn-success" href="index.php?t=data&p=resensi&f=resensi_form_view"> <i class="glyphicon glyphicon-arrow-left"></i> Kembali</a>

				<h3>Update Gambar</h3>

				<div class="panel panel-info">
		 <div class="panel-body">
				<form action="index.php?t=data&p=resensi&f=resensi_act_update" method="post" id="form_update" name="form_update" enctype="multipart/form-data">
					...
					<div class="control-group">
							...
							<?php
									if(empty($data['gambar'])){
											echo "<img src=app/resensi/files/noimage.jpg width=55 height=55 class=img-rounded>";
										}
										else{
											echo "<img src=app/resensi/files/$data[gambar] width=150 height=150 class=img-rounded>";
										}
								?> 
						...
						<tr></br>
                            <td><label>Pengarang : </label></td></br>
                            <td>
								<input type="text" name="pengarang"  class="form-control" style=" width:400px;" 
								id="pengarang" value="<?php echo $data['pengarang'];?>" required/>							</td>
                          </tr>
						  
						<tr></br>
                            <td><label>Penerbit : </label></td></br>
                            <td>
								<input type="text" name="penerbit"  class="form-control" style=" width:400px;" 
								id="penerbit" value="<?php echo $data['penerbit'];?>" required/>							</td>
                          </tr>
						  </br>
						  <tr>
