...
<div class="col-sm-10 main">
			<h3 class="page-header"><label>Halaman Resensi Product</label></h3>
				...
				<a href="index.php?p=resensi&f=resensi_form_insert" class="btn-bg btn  btn-success pull-right">
		 ...
		 <div class="panel-body">
				<table class="table table-condensed table-bordered" id="example">
					...
					<?php
							...
							$query_page="SELECT * FROM resensi ";
					...
					<tr class="info">
						...
						<td> <?php if(empty($rows['gambar'])){
											...
											echo "<img src=app/resensi/files/$rows[gambar] width=75 height=75 class=img-rounded>";
										}
										?></td>
						...
						<td> <div class="btn-group">
							...
							<a href="index.php?t=data&p=resensi&f=resensi_act_delete&id=<?php  echo $rows['id']; ?>"
