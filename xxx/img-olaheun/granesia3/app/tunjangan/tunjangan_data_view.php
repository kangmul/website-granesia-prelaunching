...
<?php if(!isset($_POST['nama_tunjangan']) || !isset($_GET['nama_tunjangan']))
	$nama_tunjangan = '';?>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span9">
				<h3> DAFTAR POTONGAN</h3>
					...
					<form method="post" class="form-search">
						<input type="text" name="tunjangan" placeholder="Masukkan Pencarian"/>
						<a href='index.php?tab=datatabelgaji&folder=tunjangan&file=tunjangan_data_view' class="btn btn-primary" ><i class='icon-list'></i>All</a>
					</form>
				...
				<table class="table table-condensed table-bordered">
					...
					<?php
							...
							$query="SELECT * FROM t_tunjangan  
							ORDER BY nama_tunjangan LIMIT $posisi,$batas";
							$query_page="SELECT * FROM t_tunjangan";
							
							//if(isset($_POST['lokasi'])){
								//$lokasi=$_POST['lokasi'];
							if(isset($_POST['nama_tunjangan'])||isset($_GET['nama_tunjangan'])){
							isset ($_POST['nama_tunjangan']) ? $nama_tunjangan = $_POST['nama_tunjangan'] : $nama_tunjangan = $_GET['nama_tunjangan'];
							
							$query="SELECT * FROM t_tunjangan 
								WHERE nama_tunjangan LIKE '%$nama_tunjangan%' LIMIT $posisi,$batas";
								$query_page="SELECT * FROM t_tunjangan 
								WHERE nama_tunjangan LIKE '%$nama_tunjangan%'";
							}
					...
					<tr class="info">
						...
						<td>
							<div class="btn-group">
							<a href="index.php?tab=datatabelgaji&folder=tunjangan&file=tunjangan_form_update&id_tunjangan=<?php echo $rows['id_tunjangan']; ?>" class="btn-small btn btn-warning">
								<i class="icon icon-pencil"></i> Update</a>
							<a href="index.php?tab=datatabelgaji&folder=tunjangan&file=tunjangan_act_delete&id_tunjangan=<?php echo $rows['id_tunjangan']; ?>" 
					...
					<tr class="info">
						<td></td>
						<td></td>
						<td colspan="4"><a href="index.php?tab=datatabelgaji&folder=tunjangan&file=tunjangan_form_insert" class="btn-small btn  btn-success"><i class="icon icon-plus"></i> Add</a></td>
					</tr>
				</table>
