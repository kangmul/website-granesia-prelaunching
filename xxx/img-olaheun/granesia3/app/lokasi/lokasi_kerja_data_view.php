...
<?php if(!isset($_POST['lokasi']) || !isset($_GET['lokasi']))
	$lokasi = '';?>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span9">
				...
				<table class="table table-condensed table-bordered">
					...
					<?php
							...
							$query="SELECT * FROM lokasi_kerja  
							ORDER BY lokasi LIMIT $posisi,$batas";
							$query_page="SELECT * FROM lokasi_kerja";
							
							//if(isset($_POST['lokasi'])){
								//$lokasi=$_POST['lokasi'];
							if(isset($_POST['lokasi'])||isset($_GET['lokasi'])){
							isset ($_POST['lokasi']) ? $lokasi = $_POST['lokasi'] : $lokasi = $_GET['lokasi'];
							
							$query="SELECT * FROM lokasi_kerja 
								WHERE lokasi LIKE '%$lokasi%' LIMIT $posisi,$batas";
								$query_page="SELECT * FROM lokasi_kerja 
					...
					<tr class="info">
						...
						<td>
							<div class="btn-group">
							<a href="index.php?tab=datatabel&folder=lokasi&file=lokasi_form_update&id_lks_kerja=<?php echo $rows['id_lks_kerja']; ?>" class="btn-small btn btn-warning">
								<i class="icon icon-pencil"></i> Update</a>
							<a href="index.php?tab=datatabel&folder=lokasi&file=lokasi_act_delete&id_lks_kerja=<?php echo $rows['id_lks_kerja']; ?>" 
					...
					<tr class="info">
						<td></td>
						<td></td>
						<td colspan="4"><a href="index.php?tab=datatabel&folder=lokasi&file=lokasi_form_insert" class="btn-small btn  btn-success"><i class="icon icon-plus"></i> Add</a></td>
					</tr>
				</table>
