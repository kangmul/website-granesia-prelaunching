...
<?php if(($_SESSION['role_id']=='1')||($_SESSION['role_id']=='2')){?>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<form action="index.php?tab=datatabel&folder=lokasi&file=lokasi_act_insert" method="post" id="form_insert" name="form_insert">
		
					<div class="control-group">
						<label for="password">Lokasi Kerja : </label>
						<div class="controls">
							<input type="text" name="lokasi" id="lokasi" placeholder="lokasi" maxlength="20" required/>
						</div>
