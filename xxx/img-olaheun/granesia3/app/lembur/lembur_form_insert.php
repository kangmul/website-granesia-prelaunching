...
<?php if(($_SESSION['role_id']=='1')||($_SESSION['role_id']=='3')){?>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<form action="index.php?tab=datatabelgaji&folder=lembur&file=lembur_act_insert" method="post" id="form_insert" name="form_insert">
		
					<div class="control-group">
						<label for="password">Nama Lembur : </label>
						<div class="controls">
							<input type="text" name="nm_lembur" id="nm_lembur" placeholder="Nama Lembur" maxlength="20" required/>
						</div>
