...
<form method="POST" action="cek_login.php" accept-charset="UTF-8">
	<table>
		...
		<tr>	
			...
			<td valign="top">:</td>
			<td><input class="span18" placeholder="Username" type="text" name="username" required></td>
		</tr>
		<tr>	
			<td valign="top"><label>Password</label></td>
			<td valign="top">:</td>
			<td><input class="span18" placeholder="Password" type="password" name="password" required></td>
		</tr>
		<tr>
