...
$query2 = "UPDATE lembur SET hps = '1' WHERE lembur.id='$id'";
...
mysql_close();
$_SESSION['pesan'] = '<p><div class="alert alert-success"><b>Data Lembur Karyawan Berhasil Dihapus</b> </b></div></p>';
		$st = '1';
		include('gaji_karyawan_lembur_form_view.php');
