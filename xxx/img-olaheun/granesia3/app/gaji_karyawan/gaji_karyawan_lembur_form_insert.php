...
$id = isset($_GET['id']) ? $id = $_GET['id'] : '';
if ($id == '') {
    $urut = $fungsi->fungsi->urut("lembur", "id");
    $query = "INSERT INTO lembur (id,id_karyawan,periode,tahun) VALUES ('','$index','$bulan','$tahun')";
	$db->query($query);
    $fungsi->fungsi->redirect('index.php?tab=datagaji&folder=gaji_karyawan&file=gaji_karyawan_lembur_form_insert&id=' .$urut);
} else {
    $query = "SELECT * FROM lembur WHERE id=$id LIMIT 1";
...
<div class="row-fluid">
				<div class="span12">
					<form action="index.php?tab=datagaji&folder=gaji_karyawan&file=gaji_karyawan_lembur_act_insert" method="post">
                    ...
                    <tr class="info">
					  <td colspan="6"><h4><center>FORM INPUT DATA LEMBUR KARYAWAN</center></h4></td>
					  </tr>
...
<?php
    require_once 'app/gaji_karyawan/detail-njo-form3.php';
    ?>
