...
#list_container {
	text-align: center;
                ...
                <form action="" method="post" id="form-input">
					...
					<tr>
						<td>
							<select class ="span11" name="id_tunjangan" id="id_tunjangan" class="satu form-control input-sm" required>
							<option value="">-Pilih Tunjangan-</option>
							<?php
							$query = "SELECT id_tunjangan,nama_tunjangan FROM t_tunjangan ";
							$fungsi->fungsi->dropsel($query, "");
							?>
							</select>
						</td>
						<td><input class ="span11" type="text" name="jumlah" id="jumlah" class="form-control input-sm"
                       placeholder="Masukan Jumlah Tunjangan" required>
						</td>
						<td><input class ="span11" type="text" name="ket" id="ket" class="form-control input-sm"
                       placeholder="Masukan Keterangan" required>
						</td>
            <td><input type="button" class="frm_button" value="Tambah" onclick="add_member2()"></td>
        </tr>
    </table>
</form>
