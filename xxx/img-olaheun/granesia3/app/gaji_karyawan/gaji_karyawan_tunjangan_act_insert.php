...
$query = "UPDATE tunjangan SET id_karyawan='$index', periode='$name', tgl_input='$tgl_input' WHERE id='$id'"; 
//echo $query;
//die ();
...
echo "<script>; 
			location.href='index.php?tab=$tab&folder=$folder&file=gaji_karyawan_tunjangan_form_view';
			</script>";
