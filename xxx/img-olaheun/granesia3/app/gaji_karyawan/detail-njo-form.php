...
#list_container {
	text-align: center;
                ...
                <form action="" method="post" id="form-input">
					...
					<tr>
						<td>
							<select class ="span11" name="id_potongan" id="id_potongan" class="satu form-control input-sm" required>
							<option value="">-Pilih Potongan-</option>
							<?php
							$query = "SELECT id_potongan,nama_potongan FROM t_potongan ";
							$fungsi->fungsi->dropsel($query, "");
							?>
							</select>
						</td>
						<td><input class ="span11" type="text" name="jumlah" id="jumlah" class="form-control input-sm"
                       placeholder="Masukan Jumlah Potongan" required>
						</td>
						<td><input class ="span11" type="text" name="ket" id="ket" class="form-control input-sm"
                       placeholder="Masukan Keterangan" required>
						</td>
            <td><input type="button" class="frm_button" value="Tambah" onclick="add_member()"></td>
        </tr>
    </table>
</form>
