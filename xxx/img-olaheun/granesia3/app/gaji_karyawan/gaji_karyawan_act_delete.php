...
$query2 = "UPDATE gaji SET hps = '1' WHERE gaji.id='$id'";
...
mysql_close();
$_SESSION['pesan'] = '<p><div class="alert alert-success"><b>Data Gaji Karyawan Berhasil Dihapus</b> </b></div></p>';
		$st = '1';
		include('gaji_karyawan_form_view.php');
