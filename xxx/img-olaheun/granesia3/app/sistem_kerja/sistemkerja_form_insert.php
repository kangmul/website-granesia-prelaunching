...
<? if($_SESSION['role_id']=='1'){?>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<h3>Form Input Waktu Kerja</h3>
				<form action="index.php?tab=datatabel&folder=sistem_kerja&file=sistemkerja_act_insert" method="post" id="form_insert" name="form_insert">
					
					<div class="control-group">
						<label for="password">Waktu Kerja : </label>
						<div class="controls">
							<input type="text" name="waktu" id="waktu" placeholder="waktu kerja" maxlength="20" required/>
						</div>
					</div>
