...
$id_pendidikan = isset($_GET['id_pendidikan']) ? $_GET['id_pendidikan'] : null;
//atau:
//$page = isset($_GET['page']) ? $_GET['page'] : false;
//atau bisa juga dengan:
//$page = isset($_GET['page']) ? $_GET['page'] : "";

$query = "SELECT * FROM tb_pend_akhir WHERE id_pendidikan='".$id_pendidikan."'";
...
<?php if(($_SESSION['role_id']=='1')||($_SESSION['role_id']=='2')){?>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<form action="index.php?tab=datatabel&folder=pendidikan&file=pendidikan_act_update" method="post" id="form_update" name="form_update">
					<input type="hidden" name="id_pendidikan" value="<?php echo $id_pendidikan; ?>" />

					<div class="control-group">
						<label for="password">Nama Tingkatan Pendidikan : </label>
						<div class="controls">
							<input value="<?php echo $data['pend_akhir']; ?>" type="text" name="pend_akhir" placeholder=""  required />
						</div>
						</div>
