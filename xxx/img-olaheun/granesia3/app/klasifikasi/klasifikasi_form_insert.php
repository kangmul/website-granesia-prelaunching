		...
		<div class="row-fluid">
			...
			<div class="span9">
				<a class="btn btn-success" href="index.php?tab=datatabel&folder=klasifikasi&file=klasifikasi_data_view"> <i class="icon icon-arrow-left"></i> Back</a>
					<h3>Input Klasifikasi</h3>
				<form action="index.php?tab=datatabel&folder=klasifikasi&file=klasifikasi_act_insert" method="post" id="form_insert" name="form_insert">
					<div class="control-group">
						<label for="klasifikasi">Input Klasifikasi : </label>
						<div class="controls">
							<input type="text" name="klasifikasi" id="klasifikasi" placeholder="input klasifikasi" maxlength="20" required/>
						</div>
					</div>
