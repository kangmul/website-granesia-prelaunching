...
<?php if(!isset($_POST['nama_gol']) || !isset($_GET['nama_gol']))
	$nama_gol = '';?>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span9">
				...
				<table class="table table-condensed table-bordered">
					...
					<?php
							...
							$query="SELECT * FROM t_golongan  
							ORDER BY id_gol LIMIT $posisi,$batas";
							$query_page="SELECT * FROM t_golongan";
							
							//if(isset($_POST['lokasi'])){
								//$lokasi=$_POST['lokasi'];
							if(isset($_POST['nama_gol'])||isset($_GET['nama_gol'])){
							isset ($_POST['nama_gol']) ? $nama_gol = $_POST['nama_gol'] : $nama_gol = $_GET['nama_gol'];
							
							$query="SELECT * FROM t_golongan 
								WHERE nama_gol LIKE '%$nama_gol%' LIMIT $posisi,$batas";
								$query_page="SELECT * FROM t_golongan 
								WHERE nama_gol LIKE '%$nama_gol%'";
							}
					...
					<tr class="info">
						...
						<td>
							<div class="btn-group">
							<a href="index.php?tab=datatabelgaji&folder=golongan&file=golongan_form_update&id_gol=<?php echo $rows['id_gol']; ?>" class="btn-small btn btn-warning">
								<i class="icon icon-pencil"></i> Update</a>
							<a href="index.php?tab=datatabelgaji&folder=golongan&file=golongan_act_delete&id_gol=<?php echo $rows['id_gol']; ?>" 
					...
					<tr class="info">
						<td></td>
						<td></td>
						<td colspan="4"><a href="index.php?tab=datatabelgaji&folder=golongan&file=golongan_form_insert" class="btn-small btn  btn-success"><i class="icon icon-plus"></i> Add</a></td>
					</tr>
				</table>
