					  ...
					  <td colspan="2"><h4><center>Form PJP Baru</h4></td>
                          ...
                          <tr>
                            ...
                            <td>
								...
								<div class="controls">		
								<select name="id_field" onChange='javascript:dinamis(this)'> <option value=''>- Departemen -</option>
									<?php 
								...
								<div class="controls">		
								<select name="id_fkerja" onChange='javascript:dinamis(this)'> <option value=''>- Fungsi Kerja -</option>
									<?php 
								...
								<div class="controls">		
								<select name="id_jabatan" onChange='javascript:dinamis(this)'> <option value=''>- Jabatan -</option>
									<?php 
								...
								<div class="controls">		
								<select name="id_lks_kerja" onChange='javascript:dinamis(this)'> <option value=''>- Lokasi Kerja -</option>
									<?php 
								...
								<select name="id_sistem_kerja" onChange='javascript:dinamis(this)'> <option value=''>- Sistem Kerja -</option>
									<?php 
										...
										while ($data=mysql_fetch_array($sql))
										{
											echo "<option value=$data[id_sistem_kerja]>$data[waktu]</option>";
										}
									?>
								</select>
								</div>
								<div class="control">
								<select name="id_klasifikasi" onChange='javascript:dinamis(this)' required> <option value=''>- Status Pekerjaan -</option>
									<?php 
