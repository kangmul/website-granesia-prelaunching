		...
		<? include ('menuhistory.php');?>
				...
				<table class="table table-condensed table-striped">
					...
					<?php
							...
							$query="SELECT * FROM history where status_baca = 'N' ORDER BY id_his DESC LIMIT $posisi,$batas";
					...
					<?php if($rows['status_baca'] == 'Y'){?>
						...
						<td>
										...
										?>
											...
											<a href="index.php?tab=datahistory&folder=history&file=history_act_update_stat_belum&id_his=<?php echo $rows['id_his']; ?>&halaman=<? echo $hal;?>" class="tooltipsku" 
