...
<?php if(($_SESSION['role_id']=='1')||($_SESSION['role_id']=='2')){?>
		...
		<div class="row-fluid">
			...
			<div class="span9">
					...
					<h3>Input Fungsi Kerja</h3>
					<form action="index.php?tab=datatabel&folder=fungsi_kerja&file=fkerja_act_insert" method="post" id="form_insert" name="form_insert">
						<div class="control-group">
							<label for="username">Fungsi Kerja : </label>
							<div class="controls">
								<input type="text" name="fkerja" id="fkerja" placeholder="Nama Fungsi" maxlength="100" required/>
							</div>
						</div>
