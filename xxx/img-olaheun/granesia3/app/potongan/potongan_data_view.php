...
<?php if(!isset($_POST['nama_potongan']) || !isset($_GET['nama_potongan']))
	$nama_potongan = '';?>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span9">
				...
				<table class="table table-condensed table-bordered">
					...
					<?php
							...
							$query="SELECT * FROM t_potongan  
							ORDER BY nama_potongan LIMIT $posisi,$batas";
							$query_page="SELECT * FROM t_potongan";
							
							//if(isset($_POST['lokasi'])){
								//$lokasi=$_POST['lokasi'];
							if(isset($_POST['nama_potongan'])||isset($_GET['nama_potongan'])){
							isset ($_POST['nama_potongan']) ? $nama_potongan = $_POST['nama_potongan'] : $nama_potongan = $_GET['nama_potongan'];
							
							$query="SELECT * FROM t_potongan 
								WHERE nama_potongan LIKE '%$nama_potongan%' LIMIT $posisi,$batas";
								$query_page="SELECT * FROM t_potongan 
								WHERE nama_potongan LIKE '%$nama_potongan%'";
							}
					...
					<tr class="info">
						...
						<td>
							<div class="btn-group">
							<a href="index.php?tab=datatabelgaji&folder=potongan&file=potongan_form_update&id_potongan=<?php echo $rows['id_potongan']; ?>" class="btn-small btn btn-warning">
								<i class="icon icon-pencil"></i> Update</a>
							<a href="index.php?tab=datatabelgaji&folder=potongan&file=potongan_act_delete&id_potongan=<?php echo $rows['id_potongan']; ?>" 
					...
					<tr class="info">
						<td></td>
						<td></td>
						<td colspan="4"><a href="index.php?tab=datatabelgaji&folder=potongan&file=potongan_form_insert" class="btn-small btn  btn-success"><i class="icon icon-plus"></i> Add</a></td>
					</tr>
				</table>
