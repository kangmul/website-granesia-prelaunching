		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<form method="post" class="form-search">
					...
					<a href='index.php?tab=datatabel&folder=picture&file=picture_data_view' class="btn btn-primary" ><i class='icon-list'></i>All</a>
				</form>
				...
				<table class="table table-condensed table-bordered">
					...
					<?php
							...
							$query="SELECT * FROM picture ORDER BY id_gallery LIMIT $posisi,$batas";
							$query_page="SELECT * FROM picture ";
								
							if(isset($_POST['keterangan'])){
							$keterangan=$_POST['keterangan'];
							$query="SELECT * FROM picture WHERE keterangan LIKE '%$keterangan%' ";
								$query_page="SELECT * FROM picture WHERE keterangan LIKE '%$keterangan%'";
					...
					<tr class="info">
						...
						<td> <?php if(empty($rows['gambar'])){
											...
											echo "<img src=app/picture/images/$rows[gambar] width=75 height=75 class=img-rounded>";
										}
										?></td>
						...
						<td> <div class="btn-group">
							...
							<a href="index.php?tab=datatabel&folder=picture&file=picture_form_update&id_gallery=<?php  echo $rows['id_gallery']; ?>" class="btn-small btn btn-warning">
								<i class="icon icon-pencil"></i> Update</a>
							<a href="index.php?tab=datatabel&folder=picture&file=picture_act_delete&id_gallery=<?php  echo $rows['id_gallery']; ?>"
					...
					<tr class="info">
						...
						<td></td>
						<td colspan="4"><a href="index.php?folder=picture&file=picture_form_insert" class="btn-small btn  btn-success"><i class="icon icon-plus"></i> Add</a></td>
					</tr>
				</table>
